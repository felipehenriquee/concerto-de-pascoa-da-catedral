...
const highlights: HighlightCard[] = [
  {
    ...
    title: "Música Sacra",
    description:
      "Repertório cuidadosamente selecionado entre clássicos da música sacra e composições contemporâneas.",
  },
  {
    icon: <Heart size={24} />,
    ...
    <section id="about" className="py-24 bg-pink-100">
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-brown-700/70 text-base md:text-lg max-w-2xl mx-auto leading-relaxed">
            ...
            Metropolitana de Fortaleza será realizado no dia 11 de Abril de 2026
            às 16:30 h. O Concerto se destaca pela riqueza, pela harmonia e pelo
            repertório que transmitirá ao público o verdadeiro sentido da
            Páscoa, a Paixão de Cristo para salvação da humanidade.
            <br />
            ...
            <span className="font-bold text-brown-700">Nadilson Martins Gama.</span>
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {highlights.map(({ icon, title, description }) => (
            ...
            >
              ...
              <h3 className="font-serif text-brown-900 text-xl">{title}</h3>
              <p className="text-brown-700/60 text-sm leading-relaxed">
                {description}
              </p>
            </div>
          ))}
